...
<form class="space-y-6" wire:submit.prevent="updateProject">
    ...
    {{-- <button class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 
                    font-medium rounded-lg text-sm px-5 py-2.5 text-center" wire:click="updateProject()" type="button" >Update</button>

    <button class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 
                    font-medium rounded-lg text-sm px-5 py-2.5 text-center" wire:click="cancel()" type="button" >Cancel</button>          --}}
