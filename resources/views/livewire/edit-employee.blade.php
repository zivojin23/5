...
<form wire:submit.prevent="updateEmployee">
    ...
    <div class="p-5 flex justify-end">
        <button class="bg-white hover:bg-green-200 font-semibold py-2 px-4 border border-gray-400 rounded-lg shadow mr-5"
        ...
        <button class="bg-white hover:bg-green-200 font-semibold py-2 px-4 border border-gray-400 rounded-lg shadow" 
                wire:click.prevent="updateEmployee()" type="submit">Update<i class="fa-solid fa-check ml-5"></i></button>
    </div>
